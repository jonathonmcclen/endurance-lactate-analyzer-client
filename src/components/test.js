      ...
      if (0 < this.gridCountR)
        for (
          ...
          "MM" == A &&
            ((g = (p - l) / z),
            1.5 <= (p - l) / z &&
              ((p = p - (g - 1) * z + d.getPeriodDuration("DD", 3)),
    ...
    draw: function () {
      ...
      if (
        ...
        if (this.logarithmic) {
          ...
          (this.relativeStart = d.fitToBounds(
            (this.min - this.fullMin) / (this.fullMax - this.fullMin),
            0,
            1
          )),
            (this.relativeEnd = d.fitToBounds(
        ...
        for (q = 0; q < k.length; q++)
          if (((n = k[q]), n.hidden))
            ...
            if (
              ...
              r &&
                y &&
                (y = this.data[p].axes[this.id].graphs[y.id]) &&
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
      ...
      P &&
        ...
        ((ca =
          a.autoWrap && 0 === n
            ? d.wrappedText(y, c, w, t, r, ga, k, Math.abs(g), 0)
            ...
            case "ohlc":
              if (!(isNaN(ua) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                ...
                if (t) {
                  ...
                  0 <= O &&
                    O <= pa &&
                    (qb = d.line(g, [O, O], [Ib, Tb], Ha, X, da, ea));
                  0 < F &&
                    F < q &&
                    (pb = d.line(g, [qa, sa], [F, F], Ha, X, da, ea));
                  0 <= E &&
                    E <= pa &&
                    (rb = d.line(g, [E, E], [Tb, Jb], Ha, X, da, ea));
                } else {
                  la = F;
                  "open" == l && (la = N);
                  "high" == l && (la = ta);
                  ...
                  0 <= N &&
                    N <= Fa &&
                    (qb = d.line(g, [Kb, Ub], [N, N], Ha, X, da, ea));
                  0 < E &&
                    E < n &&
                    (pb = d.line(g, [E, E], [ra, ta], Ha, X, da, ea));
                  0 <= F &&
                    F <= Fa &&
                    (rb = d.line(g, [Ub, Lb], [F, F], Ha, X, da, ea));
                }
                fa.push(qb);
                fa.push(pb);
                fa.push(rb);
    ...
    drawLineGraph: function (a, b, c, e) {
      ...
      if (1 < a.length) {
        ...
        var y = g.negativeLineColor,
          ...
          z = g.baseCoord;
        0 !== g.negativeBase &&
          ((z = g.valueAxis.getCoordinate(g.negativeBase, f)),
  ...
  d.SimpleChartScrollbar = d.Class({
    ...
    handleDragStart: function () {
      if (this.enabled) {
        ...
        this.removeCursors();
        d.isModern &&
          this.dragger.node.setAttribute("style", this.dragCursorDown);
        this.dragging = !0;
        var b = this.getDBox();
        this.rotate
      ...
      if (
        ...
        d.parseDates && !d.equalSpacing
          ? ((a = d.stepWidth),
            ...
            (c = a * (this.endTime - c)))
          : (a[this.start] && (b = a[this.start].x[d.id]),
            a[this.end] && (c = a[this.end].x[d.id]),
            (a = d.stepWidth),
            d.startOnAxis || ((e = a / 2), (b -= e), (c += e)));
        this.stepWidth = a;
        ...
        if (this.show) {
          ...
          this.drop
            ? ((h = C / 1.6),
              ...
              "V" == x && (x = "down"),
              "H" == x && (x = "left"),
              "down" == x && ((D = a + 1), (z = b - h - h / 3)),
              "up" == x && ((l = 180), (D = a + 1), (z = b + h + h / 3)),
              "left" == x && ((l = 270), (D = a + h + h / 3 + 2), (z = b)),
              "right" == x && ((l = 90), (D = a - h - h / 3 + 2), (z = b)),
              (k = z - H / 2 + 1),
              (m = D - K / 2 - 1),
          ...
          0 < this.animationDuration &&
            ...
            f.animate({ translate: D - g + "," + z }, b, "easeOutSine"),
            n &&
...
(function () {
  ...
  d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    h = Math.round;
    m &&
      ((b[t] = d.roundTo(b[t], 5)), (c[t] = d.roundTo(c[t], 5)), (h = Number));
    k = "M" + (h(b[0]) + n) + "," + (h(c[0]) + f);
  ...
  d.Bezier = d.Class({
    ...
    interpolate: function (a) {
      ...
      var c = a[1].x - a[0].x,
        ...
        g = d.bezierX,
        f = d.bezierY;
      b.push({ x: a[0].x + c / g, y: a[0].y + e / f });
      var h;
      for (h = 1; h < a.length - 1; h++) {
        ...
        k = l.x - k.x;
        k > c && (k = c);
        b.push({ x: l.x - k / g, y: l.y - e / f });
        b.push({ x: l.x, y: l.y });
        b.push({ x: l.x + k / g, y: l.y + e / f });
      }
      e = a[a.length - 1].y - a[a.length - 2].y;
      c = a[a.length - 1].x - a[a.length - 2].x;
      b.push({ x: a[a.length - 1].x - c / g, y: a[a.length - 1].y - e / f });
    ...
    drawBezierMidpoint: function (a, b, c, d) {
      var g = Math.round,
        ...
        h = this.getPointOnSegment(d, c, 0.75),
        k = (d.x - a.x) / 16,
        l = (d.y - a.y) / 16,
        m = this.getPointOnSegment(a, b, 0.375);
      a = this.getPointOnSegment(f, h, 0.375);
      a.x -= k;
      a.y -= l;
      b = this.getPointOnSegment(h, f, 0.375);
      b.x += k;
      b.y += l;
    ...
    createEntry: function (a) {
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (e) {
          ...
          (m = b.createMarker(g, f, h, void 0, void 0, void 0, y, l)) &&
            m.translate(p / 2, p / 2);
        }
